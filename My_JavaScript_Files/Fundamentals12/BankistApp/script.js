...
const account1 = {
  ...
  movementsDates: [
    ...
    "2024-02-14T18:49:59.371Z",
    "2024-02-15T12:01:20.894Z",
  ],
  currency: "EUR",
  locale: "pt-PT", // de-DE
};
...
const calcDisplaySummary = (acc) => {
  ...
  const formattedMov2 = Intl.NumberFormat(acc.locale, {
    style: "currency",
    currency: "INR",
  }).format(out);
  ...
  const formattedMov3 = Intl.NumberFormat(acc.locale, {
    style: "currency",
    currency: "INR",
  }).format(interest);
...
const displayDateTime = () => {
  ...
  labelDate.innerHTML = `${day}/${month}/${year} ${hour}:${minute}:${seconds}`;
};
